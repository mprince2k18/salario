@extends('dashboard.mainpage.app', ['title' => 'Department'])
    ...
    <div class="btn-dropdown mr-1 mb-1">
      <div class="btn-group dropdown actions-dropodown">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="{{ route('department_id_multi_delete') }}" id="delete"><i data-feather="trash"></i>Delete All</a>
        </div>
      </div>
    </div>
  </div>
...
<form action="{{ route('department_id_multi_delete') }}" method="post">
          ...
          <tr>
            ...
            <td class="product-name">{{ $department->name }}</td>
            <td class="product-category">{{ $department->id }}</td>
            <td class="product-action">
              <span>
                <a href="{{ url('/app/v1/dashboard/department/edit') }}/{{ $department->id }}/{{ $department->slug }}">
                  <i data-feather="edit" class="primary"></i>
                </a>
                </span>
              <span class="action-delete"><a href="{{ url('/app/v1/dashboard/department/delete') }}/{{ $department->id }}/{{ $department->slug }}"><i data-feather="trash" class="danger"></i></a>
              </span>
            </td>
          </tr>
          ...
          <div class="data-fields px-2 mt-3">
            <div class="row">
              ...
              <div class="col-sm-12 data-field-col">
                <label for="name">Add Department</label>
