  ...
  <div class="navbar-header">
    <ul class="nav navbar-nav flex-row">
      ...
      <li class="nav-item nav-toggle">
        ...
        <i data-feather="disc" class="font-medium-4 d-none d-xl-block collapse-toggle-icon primary"></i>
      </a></li>
    </ul>
  </div>
...
<li class=" navigation-header"><span>Employee Management</span>
      ...
      <li class=" navigation-header"><span>Salary Management</span>
      </li>

      <li class=" nav-item"><a href="#"><i data-feather="credit-card" class="foo"></i><span class="menu-title" data-i18n="Payroll">Payroll</span></a>
        <ul class="menu-content">
          <li><a href="salary_benifits.html"><i data-feather="gift" class="foo"></i><span class="menu-item" data-i18n="Salary Type">Salary Benifits</span></a>
          </li>
          <li><a href="salary_setup.html"><i data-feather="tool" class="foo"></i><span class="menu-item" data-i18n="Salary Setup">Salary Setup</span></a>
          </li>
...
<li class=" navigation-header"><span>Status Section</span>
</li>
